...
globalEnvironment.add('ArrayIterator', Kind.Class)
globalEnvironment.add('Traversable', Kind.Class)

// TODO
globalEnvironment.add('Movie', Kind.Class)
globalEnvironment.add('Rental', Kind.Class)
globalEnvironment.add('Rentals', Kind.Class)
globalEnvironment.add('Customer', Kind.Class)
globalEnvironment.add('Regular', Kind.Class)
globalEnvironment.add('NewRelease', Kind.Class)
globalEnvironment.add('Childrens', Kind.Class)
globalEnvironment.add('Price', Kind.Class)
globalEnvironment.add('PriceFactory', Kind.Class)
